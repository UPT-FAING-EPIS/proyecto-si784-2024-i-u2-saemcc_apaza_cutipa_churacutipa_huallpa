...
<body>
    ...
    <div class="top-bar">
        ...
        <span class="shop-info" onclick="window.open('https://www.google.com/maps', '_blank');" onKeyPress="handleKeyPress(event);" onKeyDown="handleKeyDown(event);" onKeyUp="handleKeyUp(event);" tabindex="0" role="button">🛒 UBICACION</span>
    </div>
    <!-- Header -->
    <header class="header">
    ...
    <script>
        ...
        function handleKeyDown(event) {
            // Add any key down specific logic here if needed
        }

        function handleKeyUp(event) {
            // Add any key up specific logic here if needed
        }
